User.create!([
  {name: "Steven", email: "test@test.com", password_digest: "$2a$12$O/uut70Yz9H.AyuwjSB.3us7pwdVdeVLtLEStmQ65xVcS4RYpe4Fu", admin: true},
  {name: "Steven", email: "test2@test.com", password_digest: "$2a$12$.0QzvvY1sj6SVkrtxwi9Ue59Y6Xm04CvwsfZv6EnNdpaPuuai8Ndq", admin: false},
  {name: "Rachel", email: "test3@test.com", password_digest: "$2a$12$f8KDDHkgsS5W/fSrlTHjouJt336ldprH.Xgb.MhOnRk7fMzuJsebC", admin: false},
  {name: "Stevie", email: "test4@test.com", password_digest: "$2a$12$KaA.XyQ.bkGKphpzUQU9CeGP89vvlHda1bb6ITMQO0ISfEFLNxXDS", admin: false},
  {name: "Steveo", email: "test5@test.com", password_digest: "$2a$12$uW4MAPbIKgPQNz4HkdmqfuVn4h6wIR2PnRUx6hNBmRkd0PCsxrUbW", admin: false}
])
Supplier.create!([
